...
function MarketCard({ Icon, title, href, viewLink, delay = 0 }) {
  return (
    <RevealOnScroll delay={delay}>
      <Link
        href={href}
        className="interactive-card group flex items-center gap-3 rounded-2xl border border-gray-200 bg-white px-5 py-4 hover:no-underline sm:px-6 sm:py-5"
      >
...
export default function MarketGuidesSection({ locale = "en" }) {
  ...
  return (
    <section id="market-guides" className="bg-[#fff] pb-14 md:pb-20 lg:pb-24">
