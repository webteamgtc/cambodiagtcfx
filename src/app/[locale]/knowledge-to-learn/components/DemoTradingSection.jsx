...
export default function DemoTradingSection({ locale = "en" }) {
  ...
  return (
    <section
      id="risk-management"
      className="relative py-8 md:py-14 lg:py-16"
      style={{
  ...
  <RevealOnScroll>
    <div className="relative w-full h-[250px] md:h-[350px]">
      <Image
        src="/new-design/knowledge-demo.svg"
    ...
    <RevealOnScroll delay={100}>
      ...
      <div className="mt-6 flex flex-col gap-4 sm:flex-row sm:gap-5">
        <Link
          ...
          className="TextButton inline-flex h-11 w-full items-center justify-center rounded-full bg-[#293B93] px-4 text-white shadow-[0_6px_20px_rgba(41,59,147,0.35)] transition hover:bg-[#243575] hover:no-underline sm:w-auto sm:px-4"
        >
        ...
        <Link
          ...
          className="TextButton inline-flex h-11 w-full items-center justify-center rounded-full border border-[#293B93] bg-white/90 px-4 text-[#293B93] transition hover:bg-white hover:no-underline sm:w-auto sm:px-4"
        >
