...
const STATS = [
  { value: "7+", label: "TRADING MARKETS" },
  { value: "20+", label: "Languages Supported" },
  { value: "5", label: "Regulated Entities" },
]; 
...
export default function TradingCtaSection({ locale = "en" }) {
  ...
  return (
    <section className="relative overflow-hidden bg-[#F8FAFF] py-14 md:py-20 lg:py-24">
      <div aria-hidden className="pointer-events-none absolute inset-0" style={GRID_PATTERN_STYLE} />
      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-12">
          <div className="flex flex-col justify-center">
            <h2 className="HeadingH1 font-bold leading-[1.1] text-black">
            ...
            <div className="mt-16 flex flex-col gap-4 sm:flex-row sm:gap-5">
              <Link
                href={REGISTER_HREF}
                target="_blank"
          ...
          <div className="flex flex-col items-end justify-center gap-8 text-right md:gap-10 lg:pl-8">
            {STATS.map((stat, index) => (
              <div key={stat.label}>
                <p className="HeadingH1 font-bold leading-none text-[#293B93]">
