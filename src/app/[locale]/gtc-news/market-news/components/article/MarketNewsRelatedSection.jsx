...
import { RELATED_ARTICLES } from "../../marketNewsArticleData";
...
function RelatedCard({ item, locale }) {
  return (
    <article className="flex h-full flex-col">
      <Link
        href={localizedHref(locale, `/gtc-news/market-news/${item.slug}`)}
...
export default function MarketNewsRelatedSection({ locale }) {
  return (
    <section className="bg-white py-10 md:py-12">
      <div className="container min-w-0 max-w-full">
        <div className="mx-auto max-w-6xl">
          ...
          <Link
            href={localizedHref(locale, "/gtc-news/market-news")}
