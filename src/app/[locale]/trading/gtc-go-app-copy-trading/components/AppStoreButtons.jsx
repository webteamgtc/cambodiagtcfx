...
export function AppStoreButton({ type, variant = "dark" }) {
  ...
  return (
    <a
      ...
      className={`inline-flex w-fit items-center justify-center gap-3 rounded-xl md:px-5 px-3 py-3 transition sm:w-auto ${variants[variant] ?? variants.dark}`}
    >
      {isApple ? (
