...
const ReturnLeader = ({ data, id }) => {
    const tr = usePathTranslation("copyTradingPage.leaderboardDetail.return");
        ...
        <div className="space-y-6">
            <div className="">
                <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                    <div className="min-w-0">
                        <h2 className="HeadingH4 text-slate-900">{tr("title", "Return / Period")}</h2>
                        <p className="TextSmall mt-1 text-slate-500">{tr("subtitle", "Account return changes over time")}</p>
                    </div>
            ...
            <div className="">
                <div className="text-left">
                    <h2 className="HeadingH4 text-slate-900">{tr("monthlyTitle", "Monthly")}</h2>
                    <p className="TextSmall mt-1 text-slate-500">{tr("monthlySubtitle", "Returns of account by month")}</p>
                </div>
