...
import { FAQ_ITEMS } from "../swapUpdateData";
...
export default function SwapUpdateFaqSection() {
  const t = usePathTranslation("swapUpdatePage.faq");
  ...
  return (
    <section className="relative py-8 pb-14 md:py-16">
      ...
      <div className="container min-w-0 max-w-full">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="Text mx-auto mt-5 max-w-5xl font-normal leading-[1.7] text-[#000032]/60">
            {t("sub", 'Everything you need to know about the GTCFX demo account before you click "open."')}
          </p>
